...
@interface LBQRCodeScanController (){
    int num;
    BOOL upOrDown;
}
...
@implementation LBQRCodeScanController
...
- (void)addImageView{
    ...
    _imageView = [[UIImageView alloc]initWithFrame:CGRectMake((LBWidth-LBSWidth)/2, (LBHeight-LBSWidth)/2, LBSWidth, LBSWidth)];
    //显示扫描框
